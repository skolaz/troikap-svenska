# 14. Trollformler
För att kasta en trollformel måste du **spendera STAMINA lika med utgjutningskostnaden** (talet inom parentes) och **ROLL UNDER SKILL totalt i trollformeln du vill kasta**. En dubbel 1 kommer alltid att lyckas medan en dubbel 6 alltid kommer att misslyckas och kräver ett kast på Oops! Tabell. 
...
# Sämja (4)
Ämbetsbroder av Vänner skickar alltid ut sina alltiallo på kvällarna efter Sämja-lektionerna. Att rensa ut barerna och bordellerna från sina berusade lärlingar är ett tröttsamt arbete. Användning av denna besvärjelse får målet att testa sin lycka (eller SKILL för fiender) eller bli mycket vänlig mot trollkarlen, som om de vore en gammal vän. De kommer dock inte att agera irrationellt, och om de redan var lite av en tölp kanske det inte skulle förändra mycket. 
...
# Förvisa ande (6)
Trollkarlen förklarar tydligt, strängt varför det är omöjligt att anden kan vara här vid denna tid. Anden måste testa sin lycka (eller SKILL för fiender) eller skickas till någon mindre osannolik plats. 
...
# Spröda kvistar (2)
Du knäpper en kvist eller annat sprött föremål för att orsaka en skada hos en annan. De måste testa sin lycka (eller SKILL för fiender) eller drabbas av ett brutet ben. 
...
# Kackerlacka (5)
En populär trollformel som förvandlar besvärligt folk till förödmjukade djur. Målet måste testa sin lycka (eller SKILL för fiender) eller förvandlas till en obetydlig varelse som trollkarlen väljer. Varar för evigt. 
...
# Minska (2) 
Få något att testa dess lycka (eller SKILL för fiender) eller minska dess storlek med hälften. Varar 3 minuter.

# Drunkna (4)
Få ett måls lungor att fyllas med vatten. De måste testa sin lycka (eller SKILL för fiender). Om de misslyckas börjar de drunkna (7.9) och är oförmögna när vatten rinner ur munnen. De kan testa igen en gång per varv tills de klarar sig, vid vilken tidpunkt besvärjelsen slutar. 

# Jordbävning (5)
Trollkarlen vandrar upp sin trollkarl och trampar på trollkarlens fötter. Ett område 30 meter runt dem drabbas av en kraftig jordbävning. Alla måste testa sin lycka (eller SKILL för fiender) eller falla genom en spricka i jorden, ta fallande skada och fastna i ett jävligt stort hål (7.8.1). Byggnader kan förstöras om de inte är särskilt robusta.
...
# Rädsla (1)
I ögonen på ett stackars mål växer trollkarlen till ett urmonster från djupet av deras ödlahjärna. De kommer att försöka fly och om flykten är omöjlig kommer de att krypa ihop sig i en boll och kvida. De kan testa sin lycka (eller SKILL för fiender) för att motstå illusionen. 
...
# Blixt (3)
Trollkarlen klappar prydligt och släpper fram ljuset från tusen solar ur deras händer. Alla inom 20 meter måste testa sin tur (eller SKILL för fiender) eller bli blinda i 1d6 minuter. 

# Gillar (3)
Trollkarlen kan permanent skänka gälar till en berörd person, och ersätta deras vanliga andningsarrangemang om de misslyckas med att testa sin lycka (eller SKILL för fiender). Användbar för undervattensutflykter men mindre när den tillfogas en kille mitt i stan. Guiden kan avsluta detta efter behag. 

# Växa (2)
Få ett föremål att växa till hälften av sin storlek igen om det misslyckas med att testa sin lycka (eller SKILL för fiender). Varar i 3 minuter. 
...
# Orkan (5)
Trollkarlen viftar med händerna i luften som om de bara inte bryr sig, vilket de förmodligen inte gör, eftersom de är trollkarlar. En mäktig vindpust slår omkull alla inom 30 meter som misslyckas med att testa lyckan (eller SKILL för fiender), som orsakar 1d3-skada och skapar en fruktansvärd röra. Varar i 10 minuter. Testa lyckan varje varv om du inte tar skydd eller ta ytterligare skada. 

# Illusion (2 per tittare)
De som ser denna illusion kan testa sin lycka (eller SKILL för fiender) för att avslöja tricket. Varar tills guiden lämnar eller somnar. 
...
# Järnhand (3)
Gemene man förstår inte exakt hur nära kött och järn är när man betraktar det i förhållande till, säg, kött och lukten av varmt te. Med lite övertygelse kan trollkarlen få ett måls kött att bete sig som om det hade metallens önskvärda egenskaper. De får +1 SKILL och immunitet mot blygsamma bränder i 3 minuter. 
...
# Fred (2)
Öppna upp sinnet för universell kärlek och få två försökspersoner att testa sin lycka (eller SKILL för fiender) eller upphöra med fientligheter. De kommer fortfarande att försvara sig om de blir attackerade men kommer åtminstone att uppskatta det småaktiga i det. 

# Gift (1)
När den kastas på en vätska gör denna trollformel att den blir dödligt gift. Vätskan ger 4 skada om den är berusad och 1 skada per tur tills målet framgångsrikt testar sin lycka (eller SKILL för fiender). Vätskan tappar sin styrka efter en timme. 
...
# Teleportera (10)
Guiden eller ett mål som de väljer kan resa till vilken plats som helst inom en enda sfär omedelbart. Om de inte känner till platsen måste de testa sin lycka (eller SKILL för fiender) eller kastas vilt ur kurs till potentiellt förödande resultat. 
...
# Åska (2)
Trollkarlen höjer sina armar och ropar något lämpligt olycksbådande. Alla inom 24 meter måste testa sin tur (eller SKILL för fiender) eller bli dövade av en upprorisk åska. Tur eller inte, de kommer att bli mäktigt imponerade. 

# Tungvrickare (2)
Akta sig! Om en trollkarl skruvar på näsan och vrider fingrarna mot dig så kommer en tungvrickare till dig. Målet måste testa sin lycka (eller SKILL för fiender) eller ha sin tunga bokstavligen knuten i knutar. Detta kräver lite tid och en hel del tålamod för att reda ut det. 
...
# Spindelnät (2)
Oavsett om detta är att öppna en portal till slemplanet eller kanalisera sjukdomens sprites, kan alla vara överens om att det är ganska äckligt. Trollkarlen blåser ut "nätet" från deras näsa och allt i en kon som sträcker sig 12 meter framför trollkarlen är fångade om de inte testar sin lycka (eller SKILL för fiender). Varje varv måste allt som passerar genom eller ut ur det upprepa testet eller fastna. Torkar upp efter 12 omgångar. 

# Zed (?)
Ingen vet vad det här gör men alla som har utgjutit den försvinner direkt, för att aldrig ses igen. 
